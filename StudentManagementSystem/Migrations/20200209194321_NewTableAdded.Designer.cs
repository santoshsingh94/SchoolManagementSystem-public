...
namespace SchoolManagementSystem.Migrations
{
    ...
    [Migration("20200209194321_NewTableAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolManagementSystem.Model.Entities.Staff", b =>
                {
                    ...
                    b.Property<int>("AnyCriminalOffence")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DoYouHaveAnyDisability")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TakingAnyMedication")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolManagementSystem.Model.Entities.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AadharNo = "1234567890",
                            Address = "Varanasi",
                            AdmissionDate = new DateTime(2020, 2, 10, 1, 13, 19, 328, DateTimeKind.Local).AddTicks(6162),
                            ClassTblId = 1,
            ...
            modelBuilder.Entity("SchoolManagementSystem.Models.Entities.Event", b =>
                {
            ...
            modelBuilder.Entity("SchoolManagementSystem.Model.Entities.Staff", b =>
                {
                    b.HasOne("SchoolManagementSystem.Model.Entities.Designation", "Designation")
                        .WithMany("Staffs")
